      ...
      <div className="absolute bottom-0 left-0 right-0 bg-background border-t border-border p-6 space-y-4">
        ...
        {!showManualForm ? (
          ...
          <>
            ...
            <div className="space-y-4">
              ...
              <Button className="w-full bg-centup-green-dark hover:bg-centup-green-dark/90 rounded-2xl h-14 text-base font-semibold">
                Se connecter
              </Button>

              {/* Lien mot de passe oublié */}
              <div className="text-center">
                <Button variant="ghost" className="text-centup-green-dark text-base">
                  Mot de passe oublié ?
                </Button>
              </div>
            </div>
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-2">
            <span className="text-muted-foreground text-base">Pas encore de compte ?</span>
            <Button
              variant="ghost"
